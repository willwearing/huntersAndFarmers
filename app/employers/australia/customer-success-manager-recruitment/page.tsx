...
export default function CsmRecruitmentPage() {
  return (
    <main className="min-h-screen px-6 py-28 bg-surface-950">
      <article className="mx-auto max-w-content">
        ...
        <h1 className="mt-4 text-4xl font-bold text-surface-50">Customer Success Manager Recruitment Australia</h1>
        <p className="mt-6 text-surface-300 max-w-3xl leading-relaxed font-body">
          We recruit customer success professionals who balance retention, expansion, and operational discipline to grow recurring revenue.
        </p>
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          <Link href="/employers/australia/adelaide" className="rounded-lg border border-surface-700 px-4 py-2 text-surface-200 hover:border-accent/60">Adelaide hiring</Link>
