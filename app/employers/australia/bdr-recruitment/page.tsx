...
export default function BdrRecruitmentPage() {
  return (
    <main className="min-h-screen px-6 py-28 bg-surface-950">
      <article className="mx-auto max-w-content">
        ...
        <h1 className="mt-4 text-4xl font-bold text-surface-50">BDR Recruitment Australia</h1>
        <p className="mt-6 text-surface-300 max-w-3xl leading-relaxed font-body">
          We recruit business development talent who can generate qualified pipeline, run consistent outbound cadence, and convert prospecting activity into meetings.
        </p>
        <div className="mt-10 flex flex-wrap gap-3">
          ...
          <Link href="/employers/australia/brisbane" className="rounded-lg border border-surface-700 px-4 py-2 text-surface-200 hover:border-accent/60">Brisbane hiring</Link>
